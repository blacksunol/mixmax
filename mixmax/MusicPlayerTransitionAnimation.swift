...
final class MusicPlayerTransitionAnimation : TransitionAnimatable {
    ...
    fileprivate weak var modalVC: PlayerViewController!
    ...
    init(rootVC: ViewController, modalVC: PlayerViewController) {
        print(" init(rootVC: V")
        self.rootVC = rootVC
...
//            self.modalVC.view.removeFromSuperview()
    ...
    func willAnimation(_ transitionType: TransitionType, containerView: UIView) {
        print("func willAnimation(_ transitionType")
        if transitionType.isPresenting {
...
//            self.rootVC.tabBarView.frame.origin.y = containerView.bounds.size.height
    ...
    func finishAnimation(_ transitionType: TransitionType, didComplete: Bool) {
        print("func finishAnimation(_ tran")
